                                                  ...
                                                  <form action="{{route('customer.reg')}}" method="POST"
                                                       ...
                                                       <div class="form-group">
                                                            <input type="text" name="cusname" class="form-style"
                                                                 placeholder="Your Full Name" value="{{old('cusname')}}"
                                                                 id="cusname" autocomplete="off">
                                                       ...
                                                       <div class="form-group mt-2">
                                                            <input type="text" name="cusaddress" class="form-style"
                                                                 placeholder="Your Address" id="cusaddress"
                                                                 value="{{old('cusaddress')}}" autocomplete="off">
                                                            <i class="input-icon uil uil-lock-alt"></i>
                                                            @error('cusaddress')
                                                            <span>{{$message}}</span><br>
                                                            @enderror
                                                       ...
                                                       <div class="form-group mt-2">
                                                            <input type="text" name="cusphone" class="form-style"
                                                                 placeholder="Your Phone No" id="cusphone"
                                                                 value="{{old('cusphone')}}" autocomplete="off">
                                                            <i class="input-icon uil uil-lock-alt"></i>
                                                       ...
                                                       <div class="form-group mt-2">
                                                            <input type="file" name="cusimage" class="form-style"
                                                                 placeholder="Your Image" id="cusimage"
                                                                 value="{{old('cusimage')}}" autocomplete="off">
                                                            <i class="input-icon uil uil-lock-alt"></i>
